...
What we want to prove is that if a class $X$ with a single parent has been processed already (and hence a new complement $X$ wrt $\Sigma$ added), no later class $Y$ will add a new complement that becomes an additional parent of $X$.
