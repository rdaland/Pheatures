...
% FIGURE 3
% ROBERT SEZ: looks good except vowels are not all aligned on bottom
\begin{figure}[h]
  \centering
...
% ROBERT SEZ:
%        renamed the features in diagram into human-ish things
%        made a footnote indicating the relation between the software output and the graphs (feel free to delete)
%        changed text so it agrees with the figure
\begin{figure}[htb!]
  \centering
...
% I thought that this is the point your lit review turned up. I was under the impression this was also what Goldsmith claimed. Maybe the following:
%	"We are not aware of any proposals to date which have been fleshed out enough to be tested, and which have proven adequate. For example, Lin's dissertation found
%	that unsupervised clustering on acoustic data was excellent at distinguishing manner of articulation but not place. Conversely, unsupervised clustering of articulatory
%	data was excellent at distinguishing place but poor at place."
% Lin's dissertation, Mielke's work, and something or other by Goldsmith are what I had in mind.
% Anyways this is a part of the paper where you are in a much better position to speak than me at this point. Please revise to your liking.
