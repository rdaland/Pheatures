...
% ROBERT SEZ: ok. need
%        to rename the features in diagram into human-ish things
%        possibly make a footnote indicating the relation between the software output and the graphs
%        double-check that the figure corresponds to the text -- it has the same input as in Fig. 3
\begin{figure}[htb!]
  \centering
